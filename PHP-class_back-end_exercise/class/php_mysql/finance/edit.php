            ...
            <form action="edit_expense.php" method="post">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            ...
                            <div class="radio-item">
                                <input type="radio" name="currency" id="currency_cny" value="CNY" <?php if ($exp['currency'] == 'CNY') echo 'checked'; ?>>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="desc" name="desc" placeholder="輸入任何備註或說明..." rows="3" style="resize: vertical;"?><?= $exp['desc']; ?></textarea>
                    </div>
                </div>

                <div class="form-buttons">
                    <input type="submit" value="💾 更新消費">
